...
const CAR_IMAGES = {
  ...
  'Innova': 'https://images.unsplash.com/photo-1581540222194-0def2dea9e28?w=400&q=80',
  ...
  const handleFilterChange = (type) => {
    ...
    if (type === 'All') {
      ...
      const filtered = cars.filter(c => {
        ...
        if (type === 'Hatchback') return carTypeLower.includes('hatchback');
        if (type === 'Sedan') return carTypeLower.includes('sedan');
        if (type === 'SUV') return carTypeLower.includes('ertiga') || carTypeLower.includes('innova') || carTypeLower.includes('suv');
        return true;
      });
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full md:w-1/4 text-center md:text-right flex flex-col items-center md:items-end border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6">
                    ...
                    <p className="text-gray-400 text-3xs font-semibold mt-1">Inclusive of GST & Tolls</p>
